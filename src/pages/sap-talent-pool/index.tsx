            ...
            <section id={css.secondsection}>
                ...
                <div id={css.threeimage}>
                    <div id={css.threeimagesection}>
                        <div><Image src="/TalentPoolImages/service6.webp" height={130} width={130} alt="" /></div>
                        <div style={{ fontWeight: "600" }}>TOP TALENT</div>
                        <div style={{ fontSize: "14px",width:"300px" }}>Access independent consultants trained by Big 3 and boutique firms, plus experts and executives with experience at the world&apos;s most successful companies.</div>
                    </div>
                    <div id={css.threeimagesection}>
                        <div><Image src="/TalentPoolImages/service7.webp" height={130} width={130} alt="" /></div>
                        <div style={{ fontWeight: "600" }}>WORLD-CLASS SERVICE</div>
                        <div style={{ fontSize: "14px",width:"300px" }}>Get the service level you need—from hands-on support to automated and instant—to scope the work, present a curated slate of candidates, and manage all contracting and compliance.</div>
                    </div>
                    <div id={css.threeimagesection}>
                        <div><Image src="/TalentPoolImages/service8.webp" height={130} width={130} alt="" /></div>
                        <div style={{ fontWeight: "600" }}>BUILT FOR BUSINESS</div>
                        <div style={{ fontSize: "14px",width:"300px" }}>Rest easy with best-in-class information security, confidentiality, labor compliance, and contracting processes that adhere to the strict requirements of leading organizations.</div>
                    </div>
                </div>
            </section>
            <section>
